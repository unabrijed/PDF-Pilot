...
export default function Ocr() {
  const run = useToolRun(async (files, read, setProgress, fail) => {
  ...
  return (
    <ToolShell
      slug="ocr"
      sub="Add an invisible, searchable text layer to scanned pages (English). The OCR engine ships with the app. Everything runs on your device, even offline."
      verb="OCR"
      busy="Recognizing"
      run={run}
    />
